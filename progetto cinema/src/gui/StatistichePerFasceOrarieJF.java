...
public class StatistichePerFasceOrarieJF extends SuperJFrame {
	...
	public StatistichePerFasceOrarieJF(ControllerGUI controllerGUI) {
		...
		indietroLabel.setBounds(10, 125, 87, 82);
		opzioniEBottoniPanel.add(indietroLabel);
		creaSfondoScalatoSu(indietroLabel, "iconaIndietro.png");
		
		JLabel calcolaPerSaleLabel = new JLabel("");
		calcolaPerSaleLabel.setToolTipText("calcola statistiche");
		calcolaPerSaleLabel.setOpaque(false);
		calcolaPerSaleLabel.setBounds(414, 125, 87, 82);
		opzioniEBottoniPanel.add(calcolaPerSaleLabel);
